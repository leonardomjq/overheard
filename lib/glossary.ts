...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  {
    ...
    name: "Alpha Card",
    definition:
      "A structured opportunity brief published by Scout Daily, synthesized from public signals across Hacker News, Reddit, GitHub, and Product Hunt.",
    body: `An Alpha Card is the core unit of content on Scout Daily. Each card identifies a specific opportunity — a demand spike, frustration cluster, or emerging gap — where builders could ship something useful.
...
The name "Alpha" refers to the investing concept of alpha — excess returns above the market. In Scout Daily's context, it means identifying opportunities before they become obvious.`,
...
Scout Daily displays signal strength as data, not visual hierarchy. All cards render identically regardless of their score — the number is shown so readers can factor it into their own assessment.`,
  ...
  },
  {
    ...
    definition:
      "A concise document identifying a market opportunity, including evidence, thesis, and suggested action. The format used by Scout Daily's Alpha Cards.",
    body: `An opportunity brief is a structured document that identifies where demand exists but supply is lacking. Scout Daily's Alpha Cards are opportunity briefs formatted for quick scanning.
...
Unlike traditional market research reports that take weeks to produce and cost thousands, opportunity briefs on Scout Daily are generated daily from real-time signals. They trade depth for speed — the goal is to surface emerging patterns early, not to provide exhaustive market analysis.
...
Scout Daily detects demand spikes by monitoring engagement metrics — upvotes, comments, stars, and launches — across all four sources. When multiple signals about the same topic cluster together with above-average engagement, the pipeline flags it as a potential opportunity.
...
Scout Daily typically includes 3–8 evidence items per Alpha Card. Evidence from multiple platforms (cross-platform evidence) is weighted higher in the clustering and scoring process.`,
