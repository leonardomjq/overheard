...
export const metadata: Metadata = {
  title: "Glossary",
  description:
    "Definitions of key terms used in Scout Daily — Alpha Cards, signal strength, evidence, market signals, and more.",
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 py-8">
        ...
        <p className="font-[family-name:var(--font-serif)] text-base leading-relaxed text-text-muted mb-10">
          Key terms and concepts used in Scout Daily opportunity briefs.
          Each term is defined in the context of how Scout Daily uses it.
        </p>
